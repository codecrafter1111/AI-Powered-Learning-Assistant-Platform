...
export const getDashboard = async (req, res, next) => {
    try {
        ...
        console.log("totalFlashcardSets",totalFlashcardSets)
        ...
        flashcardSets.forEach(set => {
            ...
            starredFlashcards += set.cards.filter(s => s.isStarred).length
        });
        ...
        // Study streak(simplified - in productions,track daily activity)
